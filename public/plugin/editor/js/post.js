    ...
    $('#editor').each( function(index, element)
    {
        ...
        $(element).wysiwyg({
                ...
                .change(function(){
                    ...
                    var length = x.length;
                    var str = x.substr(length-1,length);
                    //keyup方法来自 input特效
                    keyUp(str);
                })
                .focus(function(){
