        ...
        a.options =
                jQuery.extend(!0, {
                    ...
                    dataSource: {
                        type: "html",
                        server: {
                            ajax: {url: "server.php", dataType: "html", type: "POST"},
...
(function () {
    var b = function (b, c, a) {
        return jQuery.extend(this, {options: c, observer: a, $root: b, statusesQueue: [], listStatusesQueue: []})
    };
...
(function () {
    var b = function (b, c, a) {
        return jQuery.extend(this, {options: b, observer: c, statuses: a})
    };
    b.prototype.findStatusByField = function (b, c) {
        for (var a = -1, e, d = 0; d < this.statuses.length; d++)if (e = this.statuses[d], e[c] === b[c]) {
            a = d;
            break
        }
        return a
    ...
    b.prototype.getStatusesByAction = function (b) {
        for (var c = [], a, e = 0; e < this.statuses.length; e++)a = this.statuses[e], a.action === b && c.push(a);
        return c
    };
...
(function () {
    ...
    b.prototype.findPathitem = function (b) {
        for (var c = null, a, e = 0; e < this.pathitems.length; e++)if (a = this.pathitems[e], a.path.isEqual(b, !0)) {
            c = a;
            break
        }
        return c
...
(function () {
    var b = function (a, e) {
        ...
        if (0 < d.length) {
            for (var c = 0; c < d.length; c++)if ((g = d[c]) && g.data && g.data.filterType)b = jQuery.fn.jplist.app.services.DTOMapperService.filters[g.data.filterType], jQuery.isFunction(b) && (a.dataview = b(g, a.dataview));
        ...
        return jQuery(a.dataview).map(function (a, e) {
            return e.jqElement.get()
        })
    }, e = function (a) {
        return jQuery(a.dataitems).map(function (a, e) {
            return e.jqElement.get()
        })
    }, d = function (a) {
        a.dataview = jQuery.merge([], a.dataitems)
    }, g = function (a, e) {
        for (var d, g = -1, b, c = 0; c < a.dataitems.length; c++)if (d = a.dataitems[c], d = jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(d.jqElement),
                        b = jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(e), d === b) {
            g = c;
            break
        }
        return g
        ...
        var d;
        d = g(a, e);
        -1 !== d && (a.dataitems.splice(d, 1), a.observer.trigger(a.observer.events.delItemEvent, [e, a.dataitems]))
    }, l = function (a, e) {
        e.each(function () {
            k(a, jQuery(this))
        })
        ...
        for (var b; d < e.length; d++)b =
                e.eq(d), h(a, b, g, d), d + 1 < e.length && 0 === d % 50 && window.setTimeout(function () {
            m(a, e, d, g)
        }, 0)
    }, n = function (a, e, g, b) {
    ...
    n.prototype.addDataItem = function (a, e, d) {
        h(this, a, e, d)
    };
    ...
    n.prototype.dataviewToString = function () {
        var a, e = "", d;
        for (d = 0; d < this.dataview.length; d++)a = this.dataview[d], e += a.html;
        return e
    };
...
(function () {
    var b = function (b, a) {
        for (var e, d = !1, g = 0; g < b.paths.length; g++)if (e = b.paths[g], e.isEqual(a, !0)) {
            d = !0;
            break
        }
        return d
    }, f = function (b, a) {
        return jQuery.extend(this, {options: b, observer: a, paths: []})
    };
...
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.autocompleteFilter = function (b, f, c, a, e) {
        ...
        if (jQuery.isNumeric(b) && jQuery.isNumeric(f) && google && jQuery.fn.jlocator && jQuery.fn.jlocator.store) {
            ...
            for (var l = 0; l < a.length; l++)f = a[l], g = new jQuery.fn.jlocator.store(f.jqElement, {}), k = g.country ? jQuery.trim(g.country.toLowerCase()) == jQuery.trim(c.toLowerCase()) : !1, g = google.maps.geometry.spherical.computeDistanceBetween(b, g.latlng), (g <= e || k) && d.push(f);
            return d
        }
        return a
    }
...
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.dateFilter = function (b, f, c, a, e, d) {
        for (var g, k, l = [], h = 0; h < e.length; h++)if (g = e[h], k = g.findPathitem(a))!b || !f || !c ? l.push(g) : (k = jQuery.fn.jplist.domain.dom.services.SortService.jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(k.text, d)) && "function" === typeof k.getFullYear && k.getFullYear() === b && (k.getMonth() - 1 === f && k.getDate() === c) && l.push(g);
        return l
    }
})();
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.dateRangeFilter = function (b, f, c, a, e, d, g, k, l) {
        for (var h = [], m, n, p, q, r = 0; r < f.length; r++)if (m = f[r], n = m.findPathitem(b))if (p = !jQuery.isNumeric(a) || !jQuery.isNumeric(e) || !jQuery.isNumeric(d), q = !jQuery.isNumeric(g) || !jQuery.isNumeric(k) || !jQuery.isNumeric(l), p || q)h.push(m); else if ((q = jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(n.text, c)) && jQuery.isFunction(q.getFullYear))n = new Date(a, e, d), p = new Date(g, k, l), q.setHours(0),
...
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.pathFilter = function (b, f) {
        for (var c, a, e = [], d = 0; d < f.length; d++)c = f[d], "default" === b.jqPath ? e.push(c) : (a = c.findPathitem(b)) && e.push(c);
        return e
    }
})();
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.pathGroupFilter = function (b, f) {
        ...
        for (var g = 0; g < f.length; g++) {
            e = f[g];
            for (var k = 0; k < a.length; k++)if (c = a[k], "default" === c.jqPath) {
                d.push(e);
                break
            } else(c = e.findPathitem(c)) && d.push(e)
        }
        return d
    }
})();
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.rangeFilter = function (b, f, c, a, e, d) {
        c = [];
        for (var g, k = jQuery.isNumeric(e), l = jQuery.isNumeric(d), h = 0; h < f.length; h++)if (a = f[h], g = a.findPathitem(b))g = Number(g.text.replace(/[^-0-9\.]+/g, "")), isNaN(g) || (k && l ? g >= e && g <= d && c.push(a) : k && !l ? g >= e && c.push(a) : !k && l && g <= d && c.push(a));
        return c
    }
})();
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.textFilter = function (b, f, c, a) {
        for (var e, d, g = [], k, l = 0; l < c.length; l++)e = c[l], d = e.findPathitem(f), "default" === f.jqPath ? g.push(e) : d && (d = jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(d.text, a), k = jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(b, a), -1 !== d.indexOf(k) && g.push(e));
        return g
    }
})();
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.textFilterPathGroup = function (b, f, c) {
        ...
        for (a = 0; a < c.length; a++) {
            b = c[a];
            l = !1;
            for (var h = 0; h < d.length; h++)if (k = d[h], e = k.pathObj)if ("default" === e.jqPath) {
                l = !0;
                break
            } else if (e = b.findPathitem(e))e = jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(e.text,
...
(function () {
    jQuery.fn.jplist.domain.dom.services.FiltersService.textGroupFilter = function (b, f, c, a, e) {
        ...
        for (var n = 0; n < e.length; n++)if (c = e[n], g = c.findPathitem(k), "default" === k.jqPath)l.push(c); else if (g)if (g = jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(g.text, a), "or" === f)for (m = 0; m < b.length; m++) {
...
(function () {
    ...
    jQuery.fn.jplist.domain.dom.services.SortService.datetime = function (b, f, c, a) {
        c.sort(function (e,
                         d) {
            return jQuery.fn.jplist.domain.dom.services.SortService.datetimeHelper(e, d, b, f, a)
        })
    }
})();
(function () {
    ...
    jQuery.fn.jplist.domain.dom.services.SortService.numbers = function (b, f, c) {
        c.sort(function (a, e) {
            return jQuery.fn.jplist.domain.dom.services.SortService.numbersHelper(a, e, b, f)
        })
    }
})();
(function () {
...
(function () {
    ...
    jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml = function (b) {
        var a = "", e = b[0].attributes, d = b.html();
...
(function () {
    ...
    jQuery.fn.jplist.animation.drawItems = function (b, f, c, a, e, d, g, k) {
        ...
        if (e = jQuery.fn.jplist.animation[e]) {
            ...
            if (jQuery.isFunction(m))k.on(k.events.animationStepEvent, function (e, d, g) {
                m(b, f, c, a, d)
            });
...
(function () {
    ...
    jQuery.fn.jplist.animation.Timeline = function (a, e, d) {
        return new c(a, e, d)
    }
})();
(function () {
    ...
    jQuery.fn.jplist.animation.fade.effect = function (b, f, c, a, e) {
        f.find(b.itemPath).css({opacity: (100 - e) / 100})
    };
...
(function () {
    var b = function (a, d, g, b) {
        ...
        var c = d.dataitemsToJqueryObject(), f = d.dataviewToJqueryObject(), h = !1, m, n = jQuery.extend(!0, {}, a.options, {duration: 0});
        0 >= c.length || 0 >= f.length ? (a.$noResults.removeClass("jplist-hidden"), a.$itemsBox.addClass("jplist-hidden"), b(a, d, g, f)) : (a.$noResults.addClass("jplist-hidden"), a.$itemsBox.removeClass("jplist-hidden"),
                a.options.effect ? (a.history && (m = a.history.getLastStatus()) && !m.inAnimation && (h = !0), h = h ? n : a.options, jQuery.fn.jplist.animation.drawItems(h, a.$itemsBox, c, f, a.options.effect, a.timeline, function () {
                    b(a, d, g, f)
                }, a.observer)) : (c.detach(), a.$itemsBox.append(f), b(a, d, g, f)))
    }, c = function (a) {
        a.observer.on(a.observer.events.renderList, function (d, g, b) {
            f(a, g, b)
        })
    }, a = function (a, d, g, b) {
        a = {
            ...
            timeline: null,
            timelineZero: null,
            $itemsBox: a.find(d.itemsBox).eq(0),
            $noResults: a.find(d.noResults)
        };
        a.options.effect && (a.timeline = new jQuery.fn.jplist.animation.Timeline(a.$root, a.options, a.observer));
        c(a);
        return jQuery.extend(this, a)
    };
    jQuery.fn.jplist.ui.list.views.DOMView = function (e, d, g, b) {
        return new a(e, d, g, b)
    }
})();
(function () {
    var b = function (b) {
        ...
        c = {
            ...
            $root: c,
            history: g,
            storage: new jQuery.fn.jplist.dal.Storage(c, a, e),
            collection: null,
            listView: null
        };
    ...
    jQuery.fn.jplist.ui.list.controllers.DOMController = function (b, a, e, d, g) {
        return new f(b, a, e, d, g)
    }
})();
(function () {
    var b = function (b) {
        b.observer.on(b.observer.events.renderList, function (a, e, d) {
            b.storage.save(d);
            jQuery.fn.jplist.dal.services.URIService.get(d, b.options, function (a, e) {
                var d = new jQuery.fn.jplist.domain.serverHTML.models.DataItemModel(a), f, m;
                m = (new jQuery.fn.jplist.app.dto.StatusesDTOCollection(b.options, b.observer, e)).getStatusesByAction("paging", e);
                for (var n = 0; n < m.length; n++)f = m[n], f.data.currentPage || (f.data.currentPage = 0), f = new jQuery.fn.jplist.domain.dom.services.PaginationService(f.data.currentPage,
                        f.data.number, d.count), m[n].data.paging = f;
                b.model.set(d, e)
            }, function (a) {
            }, function (a) {
            })
        ...
        g.view = new jQuery.fn.jplist.ui.list.views.ServerHTMLView(c, a, e, g.scopeObserver, g.model, g.history);
        b(g);
        return jQuery.extend(this, g)
    };
    jQuery.fn.jplist.ui.list.controllers.ServerHTML = function (b, a, e, d, g) {
        return new f(b, a, e, d, g)
    }
})();
(function () {
    var b = function (a, d, g) {
        ...
        var c = !1, f, h = jQuery.extend(!0, {}, a.options, {duration: 0});
        !d || "" === jQuery.trim(d) ? (a.$noResults.removeClass("jplist-hidden"), a.$itemsBox.addClass("jplist-hidden")) : (a.$noResults.addClass("jplist-hidden"), a.$itemsBox.removeClass("jplist-hidden"));
        a.options.effect ? (a.history && (f = a.history.getLastStatus()) && !f.inAnimation && (c = !0), c = c ? h : a.options, jQuery.fn.jplist.animation.drawItems(c, a.$itemsBox, null, jQuery(d), a.options.effect, a.timeline, function () {
            b(a, d, g)
        }, a.observer)) : (a.$itemsBox.html(d), b(a, d, g))
    }, c = function (a) {
        ...
        a.scopeObserver.on(a.scopeObserver.events.modelChanged, function (d,
                                                                          g, b) {
    ...
    jQuery.fn.jplist.ui.list.views.ServerHTMLView = function (e, d, g, b,
                                                              c, f) {
        return new a(e, d, g, b, c, f)
    }
})();
(function () {
...
(function () {
    var b = function (a) {
                ...
                a.observer.on(a.observer.events.setDeepLinksEvent, function (e) {
                    var b = window.decodeURIComponent(jQuery.trim(window.location.hash.replace("#", ""))), c = !1;
                    e = [];
                    var c = [], f, m = [], n;
            ...
            a = function (a) {
                ...
                jQuery.fn.jplist.logEnabled(a.options) && (e = jQuery.map(a.paths, function (a, e) {
                    return a && a.jqPath ? a.jqPath : ""
                }), jQuery.fn.jplist.info(a.options, "Panel paths: ", e.join(", ")))
            }, e = function (e, g, b, l) {
...
(function () {
    var b = function (b, c, a, e) {
        return jQuery.extend(this, {options: b, observer: c, history: a, $root: e})
    };
    b.prototype.create = function (b) {
        var c = null, a, e, d, g, k, l, h, m;
    ...
    jQuery.fn.jplist.ui.panel.ControlFactory =
            function (f, c, a, e) {
                return new b(f, c, a, e)
            }
})();
(function () {
    var b = jQuery.fn.jplist.domain, f = function (a, d) {
        for (var g, b = 0; b < a.length; b++)g = a[b], g.name === d.name && g.action === d.action && jQuery.extend(!0, g, d);
        return a
    }, c = function (a, d) {
        for (var g = [], b, c, f, m = 0; m < a.controls.length; m++)if (b = a.controls[m], jQuery.isFunction(b.getStatus) && (b = b.getStatus(d))) {
            c = -1;
            f = void 0;
            for (var n = 0; n < g.length; n++)if (f = g[n], f.name === b.name) {
                c = n;
                break
            }
            -1 != c ? (f = g[c], f.action == b.action && f.type !== b.type && jQuery.extend(!0, g[c], b)) : g.push(b)
        }
        return g
    ...
    jQuery.fn.jplist.ui.panel.collections.ControlsCollection = function (e, d, b, c, f) {
        return new a(e, d, b, c, f)
    }
})();
(function () {
    var b = function (b, c, a) {
...
(function () {
    ...
    jQuery.fn.jplist.dal.services.CookiesService.setCookie = function (b, f, c) {
        ...
        var a = new Date;
        c = Number(c);
        -1 == c || isNaN(c) ? document.cookie = b + "=" + f + ";path=/;" : (a.setMinutes(a.getMinutes() + c), document.cookie = b + "=" + f + ";path=/; expires=" + a.toUTCString())
    };
...
(function () {
    ...
    jQuery.fn.jplist.dal.services.URIService.get = function (b, f, c, a, e) {
        ...
        d.ajax.data.statuses = encodeURIComponent(JSON.stringify(b, function (a, e) {
            return e && e.nodeType ? null : e
        }));
        jQuery.ajax(d.ajax).done(function (a) {
            jQuery.isFunction(c) && c(a, b);
            jQuery.isFunction(d.serverOkCallback) && d.serverOkCallback(a, b)
        }).fail(function () {
            jQuery.isFunction(a) && a(b);
            jQuery.isFunction(d.serverErrorCallback) && d.serverErrorCallback(b)
        }).always(function () {
            jQuery.isFunction(e) &&
            e(b)
        })
...
(function () {
    var b = function (a, d) {
        ...
        if (d && c)b = c; else switch (d ? (c = a.$control.find('li:has(span[data-default="true"])').eq(0), 0 >= c.length && (c = a.$control.find("li:eq(0)"))) : c = a.$control.find(".active"), c = c.find("span"), a.action) {
            case "paging":
        ...
        jQuery(document).off("jplist_dropdown_close").on("jplist_dropdown_close",
                function (a, e) {
                    d.each(function () {
                        jQuery(this).is(e) || jQuery(this).find("ul").hide()
                    })
                });
    ...
    a.prototype.setStatus = function (a, d) {
        ...
        switch (this.action) {
            case "filter":
                ...
                break;
            case "sort":
                !this.inStorage && d && 0 < b.length ? (a.data.path = b.attr("data-path"), a.data.type = b.attr("data-type"), a.data.order = b.attr("data-order"), this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent,
                        [a])) : (this.$control.find("li").removeClass("active"), b = "default" == a.data.path ? this.$control.find('li:has([data-path="default"])') : this.$control.find('li:has([data-path="' + a.data.path + '"][data-type="' + a.data.type + '"][data-order="' + a.data.order + '"])'), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()));
                break;
            case "paging":
                !this.inStorage && d && 0 < b.length ? (a.data.number = b.attr("data-number"), this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent,
                        [a])) : (this.$control.find("li").removeClass("active"), b = this.$control.find('li:has([data-number="' + a.data.number + '"])'), 0 === b.length && (b = this.$control.find('li:has([data-number="all"])')), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()))
        }
    };
    jQuery.fn.jplist.ui.controls.Dropdown = function (e) {
        return new a(e)
    }
})();
(function () {
    var b = function (a, d) {
        ...
        if (d && b)c = b; else switch (d ? (b = a.$control.find('option[data-default="true"]').eq(0), 0 >= b.length && (b = a.$control.find("option").eq(0))) : b = a.$control.find("option:selected"), a.action) {
            case "paging":
        ...
        a.$control.find("option").each(function () {
            ...
            f = jQuery(this).attr("data-type");
            c && (l = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(c, f), b.push(l))
        })
    }, c = function (a) {
        ...
        switch (this.action) {
            case "filter":
                if (!this.inStorage && b)a.data.path = "default", this.history.addStatus(a),
                        this.observer.trigger(this.observer.events.statusEvent, [a]); else if ((c = this.$control.find('option[data-path="' + a.data.path + '"]')) && 0 < c.length)c.get(0).selected = !0;
                break;
            case "sort":
...
(function () {
    jQuery.fn.jplist.ui.controls.DropdownFilterDTO = function (b, f) {
        return {path: b, type: f, filterType: "path"}
    }
})();
(function () {
...
(function () {
    jQuery.fn.jplist.ui.controls.DropdownSortDTO = function (b, f, c, a, e) {
        return {path: b, type: f, order: c, dateTimeFormat: a, ignore: e}
    }
})();
(function () {
    var b = function (a, b) {
...
(function () {
    jQuery.fn.jplist.ui.controls.TextboxDTO = function (b, f, c) {
        return {path: b, ignore: c, value: f, filterType: "TextFilter"}
    }
})();
(function () {
    var b = function (a, b) {
        ...
        a.params = {
            $buttons: a.$control.find("[data-type]"),
            storageStatus: null,
            defaultView: a.$control.attr("data-default") || "list-view",
...
(function () {
    jQuery.fn.jplist.ui.controls.DefaultSortDTO = function (b, f, c, a, e) {
        return {path: b, type: f, order: c, dateTimeFormat: a, ignore: e}
    }
})();
(function () {
    var b = function (a, b) {
        var d, c, f, l, h = null, m = "";
        ...
        switch (a.$control.data("dataMode")) {
            case "static":
                a.observer.on(a.observer.events.collectionReadyEvent, function (e, d) {
                    b(a, d.dataitems)
                });
                break;
            case "filter":
                a.observer.on(a.observer.events.filterEvent, function (e, d, c) {
                    b(a, c.dataview)
                });
                break;
            case "all":
...
(function () {
    jQuery.fn.jplist.ui.controls.RangeSliderDTO = function (b, f, c, a, e) {
        return {path: b, type: "number", filterType: "range", min: f, max: c, prev: a, next: e}
    }
})();
(function () {
    var b = function (a, b) {
        ...
        c = "";
        d = a.$control.data("storage-status");
        b && d ? c = d : ((d = b ? "true" === a.$control.attr("data-selected") : a.params.selected) && (c = "path"), c = {
        ...
        a.$control.on("click", function () {
            ...
            a.history.addStatus(b(a, !1));
            a.observer.trigger(a.observer.events.forceRenderStatusesEvent,
                    [!1])
        })
    }, c = function (a) {
...
(function () {
    var b = function (a, b) {
        var d, c = [], e, f, p;
        d = a.$control.data("storage-status");
        b && d || a.params.$buttons.each(function (a, d) {
            e = jQuery(d);
            if (p = b ? "true" === e.attr("data-selected") : e.data("selected") || !1)(f = e.attr("data-path")) && c.push(f)
        });
        return d = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, {
            pathGroup: c,
        ...
        if (b.data && b.data.pathGroup && jQuery.isArray(b.data.pathGroup) && 0 < b.data.pathGroup.length)for (var e = 0; e < b.data.pathGroup.length; e++)d = b.data.pathGroup[e], c = a.params.$buttons.filter('[data-path="' + d + '"]'), 0 < c.length && (c.addClass("jplist-selected"), c.data("selected", !0))
    }, a = function (a) {
...
(function () {
    jQuery.fn.jplist.ui.controls.ButtonTextFilterDTO = function (b, f, c, a) {
        return {path: b, ignore: c, value: f, selected: a, filterType: "TextFilter"}
    }
})();
(function () {
    var b = function (a, b) {
        ...
        var c, e, f;
        a.params.$buttons.each(function (a, d) {
            c = jQuery(this);
            if (e = c.attr("data-path"))f = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(e, "text"), b.push(f)
        })
    }, c = function (a, b, c) {
        var e;
        a.params.$buttons.each(function (a, b) {
        ...
        if (b.data && b.data.textAndPathsGroup && jQuery.isArray(b.data.textAndPathsGroup) && 0 < b.data.textAndPathsGroup.length)for (var f =
...
(function () {
    jQuery.fn.jplist.ui.controls.ButtonTextFilterGroupDTO = function (b, f) {
        return {textAndPathsGroup: b, ignore: f, filterType: "textFilterPathGroup"}
    }
})();
(function () {
    var b = function (a, b) {
        ...
        a.params.$checkboxes.each(function (a,
                                            c) {
            var d;
            if (d = jQuery(this).attr("data-path"))d = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(d, "text"), b.push(d)
        })
    }, c = function (a, b, c) {
        var e;
        ...
        if (b.data && b.data.pathGroup && jQuery.isArray(b.data.pathGroup) && 0 < b.data.pathGroup.length)for (var f = 0; f < b.data.pathGroup.length; f++)c = b.data.pathGroup[f], e = a.params.$checkboxes.filter('[data-path="' + c + '"]'), 0 < e.length && (e.addClass("jplist-selected"),
                e.get(0).checked = !0)
    }, a = function (a) {
...
(function () {
    jQuery.fn.jplist.ui.controls.CheckboxGroupFilterDTO = function (b) {
        return {pathGroup: b, filterType: "pathGroup"}
    }
})();
(function () {
    var b = function (a, b) {
        ...
        if (b.data && b.data.textGroup && jQuery.isArray(b.data.textGroup) && 0 < b.data.textGroup.length)for (var l = 0; l < b.data.textGroup.length; l++)c = b.data.textGroup[l], f = a.params.$checkboxes.filter('[value="' + c + '"]'), 0 < f.length && (f.addClass("jplist-selected"), f.get(0).checked = !0)
    }, c = function (a) {
        a.params.$checkboxes.on("change", function () {
            a.history.addStatus(b(a, !1));
            a.observer.trigger(a.observer.events.forceRenderStatusesEvent,
...
(function () {
    jQuery.fn.jplist.ui.controls.CheckboxTextFilterDTO = function (b, f, c, a) {
        return {textGroup: b, logic: f, path: c, ignoreRegex: a, filterType: "textGroup"}
    }
})();
(function () {
    var b = function (a, b) {
        var c = null, f, c = a.$control.data("storage-status");
...
(function () {
    ...
    c.prototype.getDeepLink = function () {
        var a = "", c;
        this.inDeepLinking && (c = b(this,
                !1), c.data && c.data.selected && (a = this.name + this.options.delimiter0 + "selected=true"));
        return a
    };
    c.prototype.getStatusByDeepLink = function (a, c) {
        var d = null;
        this.inDeepLinking && (d = b(this, !1), d.data && ("selected" === a && "true" === c) && (d.data = {
...
(function () {
    var b = function (a) {
        ...
        a.observer.on(a.observer.events.setStatusesEvent, function (c, d, f) {
            b(a)
        });
        a.$control.on("click", function () {
            var c, d, f;
...
(function () {
    var b = function (b) {
        ...
        b.observer.on(b.observer.events.setStatusesEvent, function (a, e, d) {
